...
{
	//Lift
	BTC_lift_pilot    = ["B_medic_F","C_man_1","C_man_polo_6_F","C_man_polo_4_F","C_man_1_2_F","C_man_polo_1_F","C_man_1_3_F","C_man_p_beggar_F_afro","B_Soldier_F","C_man_polo_3_F","O_Soldier_F"];
	BTC_lift          = 1;
	BTC_lifted        = 0;
	BTC_lift_min_h    = 7;
	BTC_lift_max_h    = 12;
	...
	BTC_get_liftable_array =
	{
		...
		switch (typeOf _chopper) do
		{
			...
			//HELL CAT
			case "I_Heli_light_03_unarmed_F" : {_array = ["Motorcycle","ReammoBox","ReammoBox_F","Strategic","StaticWeapon","Car","Truck","Wheeled_APC","Tracked_APC","APC_Tracked_01_base_F","APC_Tracked_02_base_F","Air","Ship"];};
		};
		_array
	};
};
