...
switch (_shop) do
{
	...
	case "medic": {["Medic Item Shop",["donuts","coffee","spikeStrip","water","rabbit","apple","redgull","fuelF"]]};
	case "cement": {["Cement Dealer",["cement"]]};
	case "meth": {["Tuco",["methp"]]};
	case "pharmacy": {["Altis Pharmacy",["redgull","water","tbacon"]]};
	case "beer": {["Liqour Store",["beer","beer2","wine","redgull","coffee","water"]]};
};