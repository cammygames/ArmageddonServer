...
switch (_vehicle) do
{
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["textures\cops\cars\PoliceOffroad.jpg","cop"],
			...
			["textures\med\cars\MedOffroad.jpg","med"]
		];
	};
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["Textures\cops\cars\PoliceSuv.jpg","cop"],
	...
	case "B_Heli_Light_01_F":
	{
		...
		[
			...
			["textures\med\cars\MedLittlebird.jpg","med"],
	...
	case "B_MRAP_01_F":
	{
		_ret = 
		[
			["Textures\cops\cars\cop_hunter_0.paa","cop","Textures\cops\cars\cop_hunter_1.paa"]
		];
	};
	...
	case "I_Heli_light_03_unarmed_F":
	{
		_ret = 
		[
			["Textures\cops\heli\police_hellcat.jpg","cop"],
	...
	case "I_MRAP_03_F":
	{
		_ret = 
		[
			["Textures\cops\cars\strider.jpg","cop"],
			["Textures\civ\cars\strider.jpg","civ"],
			["Textures\cops\cars\striderswat.jpg","cop"]
		];
	};
